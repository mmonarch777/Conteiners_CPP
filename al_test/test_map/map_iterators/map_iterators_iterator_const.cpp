...
int	test_oper(int size, string test)
{
	...
	std::map<int, string>::iterator			it_orig_test_construct;
	std::map<int, string>::const_iterator 	it_1_orig(it_orig_test_construct);
	std::map<int, string>::const_iterator 	it_2_orig = it_orig_test_construct;
	std::pair<int, string>					pair_orig;
	ft::map<int, string>					my;
	ft::map<int, string>::iterator			it_my_test_construct;
	ft::map<int, string>::const_iterator	it_1_my(it_my_test_construct);	// Обяхательно должен быть этот конструктор и без friend class
	ft::map<int, string>::const_iterator	it_2_my = it_my_test_construct;	// Обяхательно должен быть этот конструктор и без friend class
